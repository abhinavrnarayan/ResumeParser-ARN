...
import { Upload, FileText, Briefcase, TrendingUp, CheckCircle, AlertCircle, Download, Server } from 'lucide-react';
...
function App() {
  ...
  const handleFileUpload = async (file: File, type: 'resume' | 'job') => {
    ...
    try {
      ...
      alert('Error processing file. Please make sure the Python backend is running.');
    } finally {
  ...
  const calculateMatch = async () => {
    ...
    try {
      ...
      alert('Error calculating match. Please make sure the Python backend is running.');
    } finally {
      setIsProcessing(false);
    }
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-4">
            Advanced NLP-powered resume analysis with Python backend using spaCy, scikit-learn, and FastAPI
          </p>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 max-w-2xl mx-auto">
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <p className="text-red-800 font-medium">Python Backend Not Running</p>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-800">AI Match Results</h2>
                <button
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">🔬 Technical Analysis Details</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-600">Text Similarity</p>
                  <p className="text-2xl font-bold text-blue-600">{matchResult.textSimilarity}%</p>
                  <p className="text-gray-500">TF-IDF + Cosine Similarity</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-600">Keyword Density</p>
                  <p className="text-2xl font-bold text-green-600">{matchResult.keywordDensity}%</p>
                  <p className="text-gray-500">NLP Keyword Extraction</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-600">Skills Matched</p>
                  <p className="text-2xl font-bold text-purple-600">{matchResult.matchedSkills.length}</p>
